...
var ViewcashierPageModule = /** @class */ (function () {
    function ViewcashierPageModule() {
    }
...
var ViewcashierPage = /** @class */ (function () {
    function ViewcashierPage(alertCtrl, auth, nav) {
    ...
    ViewcashierPage.prototype.ngOnInit = function () {
    };
    ViewcashierPage.prototype.initializeItems = function () {
        var _this = this;
        this.auth.viewCashiers().subscribe(function (cashier) {
            console.log(cashier);
            for (var i in cashier) {
                var foodObj = {
    ...
    ViewcashierPage.prototype.loadManager = function () {
        this.nav.navigateBack('/manager');
        this.auth.setShop(this.shopid);
    };
    ViewcashierPage.ctorParameters = function () { return [
...
//# sourceMappingURL=viewcashier-viewcashier-module-es5.js.map