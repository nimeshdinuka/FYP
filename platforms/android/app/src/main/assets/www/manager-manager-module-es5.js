...
var ManagerPage = /** @class */ (function () {
    function ManagerPage(alertCtrl, auth, nav) {
    ...
    ManagerPage.prototype.initializeItems = function () {
        var _this = this;
        this.auth.getManagers().subscribe(function (manager) {
            console.log(manager);
            console.log(_this.auth.getShop());
            console.log(_this.auth.getUser());
        }, function (error) {
            console.log(error);
        });
    };
    ManagerPage.prototype.loadAddFood = function () {
        this.nav.navigateForward('addfood');
    };
    ManagerPage.prototype.loadAddCashier = function () {
        this.nav.navigateForward('addcashier');
    };
    ManagerPage.prototype.loadCashiers = function () {
        this.nav.navigateForward('viewcashier');
    };
    ManagerPage.prototype.loadFood = function () {
        this.nav.navigateForward('viewfood');
    };
    ManagerPage.prototype.loadAddOffer = function () {
        this.nav.navigateForward('addoffer');
    };
    ManagerPage.prototype.loadOffer = function () {
        this.nav.navigateForward('viewoffers');
    };
    ManagerPage.ctorParameters = function () { return [
