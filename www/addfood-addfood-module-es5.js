...
var AddfoodPage = /** @class */ (function () {
    function AddfoodPage(alertCtrl, auth, nav) {
    ...
    AddfoodPage.prototype.ngOnInit = function () {
    };
    AddfoodPage.prototype.addFood = function () {
        var _this = this;
        this.auth.addFood(this.addFoodCredentials).subscribe(function (success) {
            if (success) {
                _this.createSuccess = true;
                _this.showPopup('Success', 'Food Added Successfully.');
            }
            else {
                _this.showPopup('Error', 'Problem adding Food.');
            }
        }, function (error) {
            _this.showPopup('Error', error);
        });
    };
    AddfoodPage.prototype.loadManager = function () {
        this.nav.navigateBack('/manager');
        this.auth.setShop(this.addFoodCredentials.shop);
    };
    AddfoodPage.prototype.showPopup = function (title, text) {
    ...
    AddfoodPage.ctorParameters = function () { return [
...
//# sourceMappingURL=addfood-addfood-module-es5.js.map