...
var TestPage = /** @class */ (function () {
    function TestPage(alertCtrl, auth, nav, loadingController) {
    ...
    TestPage.prototype.ngOnInit = function () {
        ...
        var uniqueval = function (value, index, self) {
            return self.indexOf(value) === index;
        };
        this.filter = this.items.filter(uniqueval);
        console.log(this.filter);
    };
    TestPage.prototype.loadMenu = function () {
        this.nav.navigateBack('/menu');
    };
    TestPage.prototype.loadPage = function () {
    ...
    TestPage.prototype.dinein = function () {
        this.selectedRadio = "dinein";
        console.log(this.selectedRadio);
    };
    TestPage.prototype.delivery = function () {
        this.selectedRadio = "delivery";
        console.log(this.selectedRadio);
    };
    TestPage.prototype.increase = function (data) {
        var _this = this;
        this.qty++;
        this.total = this.filter.reduce(function (a, b) { return a + (_this.qty * b.foodprice); }, 0);
    };
    TestPage.prototype.decrease = function (data) {
        this.qty--;
    };
    TestPage.prototype.removeItem = function (post) {
