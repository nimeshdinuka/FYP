...
var LoginPage = /** @class */ (function () {
    function LoginPage(alertCtrl, auth, nav, toastController) {
    ...
    LoginPage.prototype.login = function () {
        ...
        if (this.loginCredentials.username !== '' && this.loginCredentials.password !== '') {
            this.auth.login(this.loginCredentials).subscribe(function (success) {
                if (success !== 'error') {
                    console.log(success);
                    if (success[0][7] == 'customer') {
                        _this.presentToast('Login Successful');
                        _this.auth.setUser(success[0][1]);
                        _this.nav.navigateRoot('restaurants');
                    }
                    else if (success[0][7] == 'manager') {
                        _this.presentToast('Login Successful');
                        _this.auth.setShop(success[0][8]);
                        _this.auth.setUser(success[0][1]);
                        _this.nav.navigateRoot('manager');
                    }
                    else if (success[0][7] == 'admin') {
                        _this.presentToast('Login Successful');
                        _this.nav.navigateRoot('admin');
                    }
    ...
    //   await alert.present();
    // }
    LoginPage.prototype.loadRestaurant = function () {
